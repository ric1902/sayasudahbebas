                    ...
                    <div class="col-sm-6">
                        <div class="box">
                            ...
                            <form action="{{ url('orders/addtocart') }}" method="POST">
                                {{ csrf_field() }} {{--fungsi nya untuk post dari front ke back di laravel--}}
                                ...
                                <p class="text-center">
                                    ...
                                    {{--  <bu tton type="submit" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Add to wishlist"><i class="fa fa-heart-o"></i>
                                    </button>  --}}
                                </p>
